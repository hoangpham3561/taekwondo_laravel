                            ...
                            <div class="row push">
                                ...
                                <div class="col-lg-8 col-xl-5">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="example-text-input" name="name" placeholder="Please enter value category">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="example-email-input">Slug</label>
                                        <input type="text" class="form-control" id="example-email-input" name="slug" placeholder="Please enter value slug">
                                    </div>
