    ...
    <div class="content">
        ...
        <div class="block block-rounded p-3">
            ...
            <div class="block-content block-content-full">
                <form action="{{ route($adminPrefix . '.' . $cauLacBoPrefix . '.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('legacy_address') is-invalid @enderror"
                                    ...
                                    placeholder="Ghi địa chỉ theo phường/xã — quận/huyện — tỉnh/thành cũ nếu cần lưu tham chiếu">{{ old('legacy_address') }}</textarea>
                            ...
                            @include('pages.backend.caulacbo.partials.province-ward', [
                                'provinceCode' => old('province_code'),
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('head_coach_id') is-invalid @enderror"
                                    ...
                                    @foreach($coaches ?? [] as $id => $name)
                                        <option value="{{ $id }}" {{ (string) old('head_coach_id') === (string) $id ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    ...
                                    placeholder="Mô tả ngắn về câu lạc bộ">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <span class="form-text text-muted small">JPEG, PNG, GIF, WebP — tối đa 2 MB. Nếu chọn file, URL bên dưới sẽ bị ghi đè khi lưu.</span>
                                @error('logo_file')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-4">
                            <div class="block block-rounded bg-body-light mb-0 p-3">
                                <div class="block-content py-3">
                                    <h5 class="text-muted fw-semibold mb-3 small text-uppercase">Bổ sung</h5>
                                    <p class="small text-muted mb-4">
                                        Mã câu lạc bộ phải là duy nhất. Có thể gán HLV trưởng sau.
                                    </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('images') is-invalid @enderror"
                                            ...
                                            placeholder='["url1","url2"]'>{{ old('images') }}</textarea>
                                        @error('images')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
